...
totalcontain.each do |page|
    ...
    client.action(:import, summary: "Importazione della pagina #{page["title"]} #CatImporterBot", interwikiprefix: userdata[4], interwikisource: userdata[4], interwikipage: CGI.escape(page["title"]), fullhistory: true, template: true)
end